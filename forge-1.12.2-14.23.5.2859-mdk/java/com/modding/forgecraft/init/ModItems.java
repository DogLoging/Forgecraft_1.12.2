...
public class ModItems
{
	...
	public static void initialization()
	{
		...
		copper_helmet = register("copper_helmet", new ItemModArmor("copper_armor", ArmorMaterial.CHAIN, 3, 0, 45, 0, EntityEquipmentSlot.HEAD));
		copper_chestplate = register("copper_chestplate", new ItemModArmor("copper_armor", ArmorMaterial.CHAIN, 3, 0, 45, 0, EntityEquipmentSlot.CHEST));
		copper_leggings = register("copper_leggings", new ItemModArmor("copper_armor", ArmorMaterial.CHAIN, 3, 0, 45, 0, EntityEquipmentSlot.LEGS));
		copper_boots = register("copper_boots", new ItemModArmor("copper_armor", ArmorMaterial.CHAIN, 3, 0, 45, 0, EntityEquipmentSlot.FEET));
	
		steel_sword = register("steel_sword", new ItemWeaponSword(ToolMaterial.IRON, 3.0F, 0.0F, 1561));
		steel_helmet = register("steel_helmet", new ItemModArmor("steel_armor", ArmorMaterial.DIAMOND, 0, 28, -20, 3, EntityEquipmentSlot.HEAD));
		steel_chestplate = register("steel_chestplate", new ItemModArmor("steel_armor", ArmorMaterial.DIAMOND, 0, 28, -20, 3, EntityEquipmentSlot.CHEST));
		steel_leggings = register("steel_leggings", new ItemModArmor("steel_armor", ArmorMaterial.DIAMOND, 0, 28, -20, 3, EntityEquipmentSlot.LEGS));
		steel_boots = register("steel_boots", new ItemModArmor("steel_armor", ArmorMaterial.DIAMOND, 0, 28, -20, 3, EntityEquipmentSlot.FEET));
		
		titanium_sword = register("titanium_sword", new ItemWeaponSword(ToolMaterial.DIAMOND, 4.0F, 240.0F, 1561));
		titanium_helmet = register("titanium_helmet", new ItemModArmor("titanium_armor", ArmorMaterial.IRON, 6, 0, 55, 0, EntityEquipmentSlot.HEAD));
		titanium_chestplate = register("titanium_chestplate", new ItemModArmor("titanium_armor", ArmorMaterial.IRON, 6, 0, 55, 0, EntityEquipmentSlot.CHEST));
		titanium_leggings = register("titanium_leggings", new ItemModArmor("titanium_armor", ArmorMaterial.IRON, 6, 0, 55, 0, EntityEquipmentSlot.LEGS));
		titanium_boots = register("titanium_boots", new ItemModArmor("titanium_armor", ArmorMaterial.IRON, 6, 0, 55, 0, EntityEquipmentSlot.FEET));
