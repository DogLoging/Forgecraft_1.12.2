...
public class ModItems
{
	...
	public static void initialization()
	{
		...
		copper_helmet = register("copper_helmet", new ItemModArmor("copper_armor", ArmorMaterial.CHAIN, 3, 0, 50, 0, EntityEquipmentSlot.HEAD));
		copper_chestplate = register("copper_chestplate", new ItemModArmor("copper_armor", ArmorMaterial.CHAIN, 3, 0, 50, 0, EntityEquipmentSlot.CHEST));
		copper_leggings = register("copper_leggings", new ItemModArmor("copper_armor", ArmorMaterial.CHAIN, 3, 0, 50, 0, EntityEquipmentSlot.LEGS));
		copper_boots = register("copper_boots", new ItemModArmor("copper_armor", ArmorMaterial.CHAIN, 3, 0, 50, 0, EntityEquipmentSlot.FEET));
